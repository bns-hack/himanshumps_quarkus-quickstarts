...
To read more about this, please refer [here](https://github.com/quarkusio/quarkus-quickstarts/blob/3.1.3.Final/jms-quickstart/README.md)

## Testing

Open your browser to `<protocol>://<hostname>/prices.html`, and you should see a button to fetch the last price.

## Images Used

- [Redhat UBI8 OpenJDK 11](https://catalog.redhat.com/software/containers/ubi8/openjdk-11/5dd6a4b45a13461646f677f4)
- [Apache ActiveMQ Artemis](https://quay.io/repository/artemiscloud/activemq-artemis-broker?tab=tags&tag=1.0.19)
