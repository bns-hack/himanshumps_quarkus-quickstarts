...
In this application, we can see the REST services to use the MongoDB database.
...
To read more about this, please refer [here](https://quarkus.io/guides/mongodb)

## Testing

Open your browser to `<protocol>://<hostname>/fruits.html` and add new fruits to the list via the form.
...
The complete list of configurations to manage mongoDB is available [here](https://quarkus.io/guides/mongodb#configuration-reference)
